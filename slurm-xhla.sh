...
#SBATCH -o logs/hostname_%j.out            # File to which STDOUT will be written, including job ID
#SBATCH -e logs/hostname_%j.err            # File to which STDERR will be written, including job ID
